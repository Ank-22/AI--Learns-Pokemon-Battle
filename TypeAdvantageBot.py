...
class TypeAdvantagePlayer(Player):
...
async def main():
    ...
    print(
        "Type Advantage player won %d / 1500 battles[this took %f seconds]"
        % (
            Type_Advantage_player.n_won_battles, time.time() - start
        )
    )
    print(
        "Random player won %d / 1500 battles[this took %f seconds]"
        % (
    ...
    print(
        "Max Damage player won %d / 1500 battles[this took %f seconds]"
        % (
