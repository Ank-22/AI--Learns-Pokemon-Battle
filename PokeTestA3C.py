...
class A3CBot(Gen9EnvSinglePlayer):
...
async def main():
    ...
    def env_fn():
        return A3CBot(opponent=RandomPlayer(battle_format="gen9randombattle"))  # Create a new environment instance for each worker
    ...
    model_save_path = "model/A3C/a3c_exp_model_gen4.pth"
    loaded_state_dict = torch.load(model_save_path)
    a3c_trainer.global_model.load_state_dict(loaded_state_dict)
