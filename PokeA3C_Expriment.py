...
async def main():
    ...
    def env_fn():
        # Randomly choose either RandomPlayer or MaxDamagePlayer
        player_class = random.choice([RandomPlayer, MaxDamagePlayer])
        return A3CBot(opponent=player_class(battle_format="gen4randombattle"))  # Create a new environment instance
    ...
    a3c_trainer = A3CTrainer(
        ...
        gamma=0.99,
        lr=1e-3,
        reward_file="a3c_exp_rewards_gen4.csv"  # Save rewards to this file
    )
    ...
    model_save_path = "model/A3C/a3c_exp_model_gen4.pt"
